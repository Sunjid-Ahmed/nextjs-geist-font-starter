...
function Home() {
    ...
    const [isSellModalOpen, setIsSellModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const calculateTotalProfit = ()=>{
        return products.reduce((total, product)=>total + product.profit, 0);
    };
    const handleBuySubmit = ()=>{
        const profit = (newProduct.sellingPrice - newProduct.costPrice) * newProduct.quantity;
        const product = {
...
_s(Home, "ZF4AeEdebfND+maAcChopOjneHU=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_04e582be._.js.map